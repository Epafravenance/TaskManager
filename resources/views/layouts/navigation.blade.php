    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('tasks.index')" :active="request()->routeIs('tasks.*') && !request()->routeIs('admin.*')">
                    {{ __('Tasks') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('teams.index')" :active="request()->routeIs('teams.*') && !request()->routeIs('admin.*')">
                    {{ __('Teams') }}
                </x-responsive-nav-link>
